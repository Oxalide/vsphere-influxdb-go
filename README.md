...
There have been reports of the script not working correctly when the time is incorect on the vsphere or vcenter. Make sure that the time is valid or activate the NTP service on the machine.
